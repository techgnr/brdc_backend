    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created_at', models.TimeField(auto_now=True)),
                ('dowload', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categories', to='school.download')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slc_batch', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='students', to='school.campusbatch')),
            ],
            options={
